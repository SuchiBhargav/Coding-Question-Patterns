...
def find_root_to_leaf_path_numbers(currentNode, currentSum):
    ...
    if currentNode.left is None and currentNode.right is None:
        ...
        return find_root_to_leaf_path_numbers(currentNode.left, currentSum) + find_root_to_leaf_path_numbers(
...
def find_root_to_leaf_path_numbers(currentNode, pathSum):
    ...
    return find_root_to_leaf_path_numbers(currentNode.left, pathSum) + find_root_to_leaf_path_numbers(currentNode.right,
                                                                                                      pathSum)
