...
def find_smallest_range(lists):
    ...
    for arr in lists:
        ...
        currentMaxNumber = max(currentMaxNumber, arr[0])  # holding the max of current minHeap
    ...
    while len(minHeap) == len(lists):
        ...
        # if current range is greater than the next possible range with "num" then change the range variables
